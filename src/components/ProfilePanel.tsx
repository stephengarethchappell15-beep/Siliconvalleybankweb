...
import { User as UserIcon, Mail, Phone, MapPin, CreditCard, Calendar, Save, CheckCircle2, AlertCircle, Camera, Upload, Trash2, Eye, EyeOff } from 'lucide-react';
          ...
          <div className="text-center sm:text-left space-y-2 flex-1">
            ...
            <div className="flex items-center justify-center sm:justify-start gap-2 text-xs text-slate-400 font-mono">
              <span className="flex items-center gap-1">
                <CreditCard className="w-3.5 h-3.5 text-slate-500" /> Account #: {maskAccountNumber(user.accountNumber, showAccountNum)}
              </span>
              <button
                type="button"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <label className="block text-xs font-semibold text-slate-300">System Assigned Account Number</label>
              <button
                type="button"
                onClick={() => setShowAccountNum(!showAccountNum)}
              ...
              >
                {showAccountNum ? <EyeOff className="w-3.5 h-3.5" /> : <Eye className="w-3.5 h-3.5" />}
                <span>{showAccountNum ? 'Hide' : 'Reveal'}</span>
              </button>
            </div>
            <div className="relative">
              ...
              <input
                type="text"
                value={maskAccountNumber(user.accountNumber, showAccountNum)}
                disabled
